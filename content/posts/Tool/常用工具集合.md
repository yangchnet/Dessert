...
## 31. Astral - 管理GitHub上star的项目

https://app.astralapp.com/

## 32. SnippetsLab - 代码片段管理工具(MAC)

https://www.renfei.org/snippets-lab/

## 33. CodeRunner 短代码测试工具（MAC）

https://coderunnerapp.com/

## 34. syncthing 多设备同步工具（全平台）

https://syncthing.net/downloads/

## 35. ForkLift3 MAC文件管理
https://binarynights.com/

## 36. cockos gif录制工具(windows, mac)
...
## 39. shortcat 丢掉鼠标，使用键盘(MAC)
https://shortcat.app/

## 40. manictime 跨平台时间追踪工具
https://www.manictime.com/linux/download

## 41. hammerspoon 一款免费又强大的 macOS 自动化工具 
http://www.hammerspoon.org/

## 42. Wave Terminal
一个类似wrap的新终端： https://www.waveterm.dev/